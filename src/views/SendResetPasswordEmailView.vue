        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Password reset link was sent</h5>
                ...
                <div class="modal-body">
                    <div class="w-100">
                        <p>If you've provided correct email you should get a link</p>
                    </div>
                </div>
    ...
    methods: {
        resend() {
            ...
            let config = {
                ...
                url: this.$sendPasswordResetEmailEndpoint,
